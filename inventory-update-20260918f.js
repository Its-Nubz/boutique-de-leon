(() => {
  ...
  const additions = [
    ...
    {brand:"CELLAbeauti",product:"PDRN Solution Salmon Ampoule",size:"35 mL / 1.18 fl oz",retail:"",price:"",categoryLabel:"Skincare / Ampoule",categories:["new","skincare"],status:"1 Available",image:""},
