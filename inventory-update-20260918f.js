(() => {
  ...
  const additions = [
    ...
    {brand:"CELLAbeauti",product:"PDRN Solution Salmon Ampoule",size:"35 mL / 1.18 fl oz",retail:"",price:"$35",categoryLabel:"Skincare / Ampoule",categories:["new","skincare"],status:"1 Available",image:""},
    {brand:"CELLAbeauti",product:"PDRN Ampoule — Cica",size:"",retail:"",price:"",categoryLabel:"Skincare / Ampoule",categories:["new","skincare"],status:"1 Available",image:""},
