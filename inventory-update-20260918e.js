(() => {
  ...
  const additions = [
    ...
    {brand:"ELIYA SKIN",product:"Skin Nourish Mask - Infused with Coral Grass & Green Algae Extracts",size:"100 mL / 3.4 fl oz",retail:"$299.99",price:"",categoryLabel:"Skincare / Face Mask",categories:["new","skincare"],status:"1 Available",image:"https://eliyaskin.com/cdn/shop/files/EA-NOURISHMASKwbox.jpg"},
    {brand:"ROYALE",product:"Multi-Purpose Ceramic Hair Brush - Rose Gold",size:"Dual Voltage 110V-240V",retail:"$500",price:"",categoryLabel:"Hair / Styling Tool",categories:["new","hair"],status:"1 Available",image:"https://royaleusa.com/cdn/shop/files/RHB02.jpg"}
  ];
